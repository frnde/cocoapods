Pod::Spec.new do|s|
    ...
    s.source= { :git => "https://github.com/frnde/WSAssetPickerController.git", :tag => "v0.2.1" }
    s.source_files = "src/*.{h,m}"
    s.framework = "QuartzCore", "AssetsLibrary", "UIKit", "CoreGraphics"
    s.requires_arc = true
    s.resources = "demo/WSAssetViewSelectionIndicator.png","demo/WSAssetViewSelectionIndicator@2x.png", "demo/overlay.png", "demo/overlay@2x.png", "demo/videoIcon.png", "demo/videoIcon@2x.png"
end